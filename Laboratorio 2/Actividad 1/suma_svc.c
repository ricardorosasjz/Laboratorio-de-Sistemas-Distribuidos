...
//Directivas para que el compilador pueda utilizar un identificador
#ifndef SIG_PF
...
suma_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
        ...
        //Procedimientos remotos soportados
        ...
        //Procedimiento suma
        case SUMA:
                _xdr_argument = (xdrproc_t) xdr_intpair; //Serialización
                _xdr_result = (xdrproc_t) xdr_int;

                //Se establece un puntero
                local = (char *(*)(char *, struct svc_req *)) suma_1_svc;
                break;
        //Pocedimiento distinto a todos los anteriores
        default:
